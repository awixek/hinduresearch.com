const scientistArticlesData = [
...

  {
    ...
    name_hi: "वररुचि",
    name_en: "Vararuchi",
    field_hi: "व्याकरण एवं भाषा विज्ञान",
    field_en: "Grammar & Linguistics",
    era_hi: "प्राचीन भारत",
    era_en: "Ancient India",
    image: "Vararuchi.png",
    summary_hi: "संस्कृत व्याकरण और भाषा-अध्ययन की प्राचीन परंपरा से जुड़े विद्वान, जिनकी परंपरा भारतीय भाषावैज्ञानिक चिंतन में महत्वपूर्ण है।",
    summary_en: "A scholar associated with ancient Sanskrit grammatical traditions and the development of Indian linguistic thought.",
    externalUrl: "vararuchi-grammar-linguistics.html"
  },

  {
    ...
    field_hi: "व्याकरण एवं भाषा विज्ञान",
    field_en: "Grammar & Linguistics",
    era_hi: "लगभग ५वीं–४थी शताब्दी ईसा पूर्व",
    era_en: "c. 5th–4th century BCE",
    image: "Panini.png",
    summary_hi: "अष्टाध्यायी के रचयिता, जिन्होंने संस्कृत व्याकरण को अत्यंत व्यवस्थित नियमों और संक्षिप्त सूत्रों की प्रणाली में प्रस्तुत किया।",
    summary_en: "Author of the Ashtadhyayi, who organized Sanskrit grammar into an extraordinarily systematic rule-based framework.",
    externalUrl: "panini-ashtadhyayi-linguistics.html"
  },
  ...
  {
    id: 31,
    slug: "charaka-tradition",
    name_hi: "चरक परंपरा",
    name_en: "Charaka Tradition",
    field_hi: "आयुर्वेद एवं चिकित्सा",
    field_en: "Ayurveda & Medicine",
    era_hi: "प्राचीन भारत",
    era_en: "Ancient India",
    image: "Charaka-Tradition.png",
    summary_hi: "आयुर्वेद की चिकित्सकीय परंपरा जिसमें रोग-निदान, आहार, शरीर-विज्ञान और चिकित्सक के आचरण पर व्यवस्थित विचार मिलता है।",
    summary_en: "The medical tradition represented by the Charaka corpus, covering diagnosis, diet, physiology and the conduct of physicians.",
    externalUrl: "charaka-tradition-ayurveda-medicine.html"
  },
...

  {
    id: 36,
    slug: "dhanvantari",
    name_hi: "भगवान धन्वंतरि",
    name_en: "Dhanvantari",
    field_hi: "आयुर्वेद एवं चिकित्सा परंपरा",
    field_en: "Ayurveda & Medical Tradition",
    era_hi: "पौराणिक एवं परंपरागत काल",
    era_en: "Mythic & Traditional Era",
    image: "Dhanvantari.png",
    summary_hi: "भारतीय परंपरा में आयुर्वेद और चिकित्सा के दिव्य आदिपुरुष के रूप में पूजित धन्वंतरि, जिनसे चिकित्सा-परंपरा का सांस्कृतिक संबंध जोड़ा जाता है।",
    summary_en: "Revered in Indian tradition as a divine figure associated with Ayurveda and medicine and with the cultural lineage of healing.",
    externalUrl: "dhanvantari-ayurveda-history.html"
  },

  {
    id: 37,
    slug: "nagarjuna-buddhist",
    name_hi: "नागार्जुन बौद्ध दार्शनिक",
    name_en: "Nagarjuna the Philosopher",
    field_hi: "दर्शन एवं तर्क",
    field_en: "Philosophy & Logic",
    era_hi: "लगभग २री–३री शताब्दी ई.",
    era_en: "c. 2nd–3rd century CE",
    image: "Nagarjuna-Philosopher.png",
    summary_hi: "माध्यमक दर्शन के महान दार्शनिक, जिन्होंने शून्यता, प्रतित्यसमुत्पाद और तर्कपूर्ण दार्शनिक विश्लेषण की प्रभावशाली परंपरा विकसित की।",
    summary_en: "A major Madhyamaka philosopher associated with influential analyses of emptiness, dependent origination and philosophical reasoning.",
    externalUrl: "nagarjuna-madhyamaka-philosophy.html"
  },

  {
    id: 38,
    slug: "uddalaka-aruni",
    name_hi: "उद्दालक आरुणि",
    name_en: "Uddalaka Aruni",
    field_hi: "दर्शन एवं प्राकृतिक चिंतन",
    field_en: "Philosophy & Natural Thought",
    era_hi: "प्राचीन भारत",
    era_en: "Ancient India",
    image: "Uddalaka-Aruni.png",
    summary_hi: "उपनिषदों के प्रमुख ऋषि जिनके संवादों में पदार्थ, चेतना, कारण-कार्य और अस्तित्व पर गहरे दार्शनिक प्रश्न उठाए गए हैं।",
    summary_en: "A major Upanishadic sage whose dialogues explore matter, consciousness, causation and the nature of existence.",
    externalUrl: "uddalaka-aruni-upanishadic-thought.html"
  },

  {
    id: 39,
    slug: "kanada-vaisheshika",
    name_hi: "कणाद और वैशेषिक परंपरा",
    name_en: "Kanada & Vaisheshika Tradition",
    field_hi: "प्राकृतिक दर्शन एवं परमाणु सिद्धांत",
    field_en: "Natural Philosophy & Atomism",
    era_hi: "प्राचीन भारत",
    era_en: "Ancient India",
    image: "Kanada-Tradition.png",
    summary_hi: "वैशेषिक परंपरा ने पदार्थ, गुण, कर्म और सूक्ष्म कणों के आधार पर प्राकृतिक जगत को वर्गीकृत और समझने का प्रयास किया।",
    summary_en: "The Vaisheshika tradition classified and analyzed the natural world through categories of matter, qualities, motion and minute particles.",
    externalUrl: "kanada-vaisheshika-natural-philosophy.html"
  },

  {
    id: 40,
    slug: "sushruta-tradition",
    name_hi: "सुश्रुत परंपरा",
    name_en: "Sushruta Tradition",
    field_hi: "शल्य चिकित्सा एवं शरीर-विज्ञान",
    field_en: "Surgery & Anatomy",
    era_hi: "प्राचीन भारत",
    era_en: "Ancient India",
    image: "Sushruta-Tradition.png",
    summary_hi: "सुश्रुत संहिता से विकसित शल्य चिकित्सा परंपरा में घाव, शल्य उपकरण, पुनर्निर्माण और चिकित्सकीय प्रशिक्षण पर विस्तृत विचार मिलता है।",
    summary_en: "The surgical tradition represented by the Sushruta corpus includes detailed discussion of wounds, instruments, reconstruction and medical training.",
    externalUrl: "sushruta-surgical-tradition.html"
  },
  ...
  {
    id: 43,
    slug: "samarangana-sutradhara",
    name_hi: "समरांगण सूत्रधार परंपरा",
    name_en: "Samarangana Sutradhara Tradition",
    field_hi: "वास्तु एवं अभियांत्रिकी",
    field_en: "Architecture & Engineering",
    era_hi: "मध्यकालीन भारत",
    era_en: "Medieval India",
    image: "Samarangana-Sutradhara.png",
    summary_hi: "स्थापत्य, नगर-योजना, यंत्रों और निर्माण तकनीकों पर महत्वपूर्ण भारतीय वास्तु-ज्ञान परंपरा।",
    summary_en: "An important Indian architectural tradition covering building design, town planning, mechanisms and construction techniques.",
    externalUrl: "samarangana-sutradhara-architecture-engineering.html"
  },

  {
    ...
    name_hi: "कौटिल्य",
    name_en: "Kautilya",
    field_hi: "राजनीति, अर्थशास्त्र एवं प्रशासन",
    field_en: "Political Economy & Administration",
    era_hi: "लगभग ४थी शताब्दी ईसा पूर्व",
    era_en: "c. 4th century BCE",
    image: "Kautilya.png",
    summary_hi: "अर्थशास्त्र से जुड़े आचार्य जिन्होंने राज्य, अर्थव्यवस्था, कर-व्यवस्था, खनन, व्यापार और प्रशासन पर व्यवस्थित विचार प्रस्तुत किए।",
    summary_en: "The scholar associated with the Arthashastra, offering systematic discussion of statecraft, economy, taxation, mining, trade and administration.",
    externalUrl: "kautilya-arthashastra-economics.html"
  },

  {
    id: 45,
    slug: "patanjali-mahabhashya",
    name_hi: "पतंजलि व्याकरणाचार्य",
    name_en: "Patanjali the Grammarian",
    field_hi: "व्याकरण एवं भाषा विज्ञान",
    field_en: "Grammar & Linguistics",
    era_hi: "लगभग २री शताब्दी ईसा पूर्व",
    era_en: "c. 2nd century BCE",
    image: "Patanjali-Grammarian.png",
    summary_hi: "महाभाष्य के रचयिता माने जाने वाले महान व्याकरणाचार्य, जिन्होंने पाणिनीय व्याकरण की गहरी व्याख्या की।",
    summary_en: "The grammarian associated with the Mahabhashya, offering a profound commentary on the Paninian grammatical tradition.",
    externalUrl: "patanjali-mahabhashya-grammar.html"
  },

  {
    ...
    name_hi: "भर्तृहरि",
    name_en: "Bhartrhari",
    field_hi: "भाषा दर्शन एवं व्याकरण",
    field_en: "Philosophy of Language & Grammar",
    era_hi: "लगभग ५वीं शताब्दी ई.",
    era_en: "c. 5th century CE",
    image: "Bhartrhari.png",
    summary_hi: "वाक्यपदीय के दार्शनिक और भाषावैज्ञानिक चिंतक, जिन्होंने भाषा, अर्थ और चेतना के संबंध पर गहन विचार किया।",
    summary_en: "A philosopher of language associated with Vakyapadiya, exploring relationships among language, meaning and cognition.",
    externalUrl: "bhartrhari-vakyapadiya-language-philosophy.html"
  },

  {
    ...
    name_hi: "अमर सिंह",
    name_en: "Amarasimha",
    field_hi: "भाषा विज्ञान एवं कोश विज्ञान",
    field_en: "Lexicography & Linguistics",
    era_hi: "लगभग ५वीं–६वीं शताब्दी ई.",
    era_en: "c. 5th–6th century CE",
    image: "Amarasimha.png",
    summary_hi: "अमरकोश के रचयिता माने जाने वाले कोशकार, जिनकी कृति संस्कृत शब्द-संपदा के अध्ययन की आधारभूत कृतियों में है।",
    summary_en: "The lexicographer associated with Amarakosha, a foundational work for the study of Sanskrit vocabulary and semantic categories.",
    externalUrl: "amarasimha-amarakosha-lexicography.html"
  },

  {
    id: 48,
    slug: "sushruta-plastic-surgery",
    name_hi: "सुश्रुत और पुनर्निर्माण शल्य चिकित्सा",
    name_en: "Sushruta & Reconstructive Surgery",
    field_hi: "पुनर्निर्माण शल्य चिकित्सा",
    field_en: "Reconstructive Surgery",
    era_hi: "प्राचीन भारत",
    era_en: "Ancient India",
    image: "Sushruta-Reconstructive.png",
    summary_hi: "भारतीय शल्य परंपरा में नाक के पुनर्निर्माण और अन्य reconstructive procedures से जुड़े वर्णनों का ऐतिहासिक अध्ययन।",
    summary_en: "A historical study of reconstructive procedures in the Indian surgical tradition, including descriptions associated with nasal reconstruction.",
    externalUrl: "sushruta-reconstructive-surgery-history.html"
  },

  {
    id: 49,
    slug: "indian-metallurgy",
    name_hi: "भारतीय धातुकर्म परंपरा",
    name_en: "Indian Metallurgical Tradition",
    field_hi: "धातुकर्म एवं सामग्री विज्ञान",
    field_en: "Metallurgy & Materials Science",
    era_hi: "प्राचीन से मध्यकालीन भारत",
    era_en: "Ancient to Medieval India",
    image: "Indian-Metallurgy.png",
    summary_hi: "लोहा, इस्पात, जस्ता और अन्य धातुओं के उत्पादन तथा प्रसंस्करण की दीर्घ भारतीय तकनीकी परंपरा का विस्तृत अध्ययन।",
    summary_en: "A detailed study of India's long technological tradition in the production and processing of iron, steel, zinc and other metals.",
    externalUrl: "indian-metallurgy-iron-steel-zinc.html"
  },

  {
    id: 50,
    slug: "ancient-indian-science",
    name_hi: "प्राचीन भारतीय विज्ञान परंपरा",
    name_en: "Ancient Indian Scientific Tradition",
    field_hi: "विज्ञान का इतिहास",
    field_en: "History of Science",
    era_hi: "प्राचीन एवं मध्यकालीन भारत",
    era_en: "Ancient & Medieval India",
    image: "Ancient-Indian-Science.png",
    summary_hi: "गणित, खगोलशास्त्र, चिकित्सा, धातुकर्म, भाषा विज्ञान और प्राकृतिक दर्शन को जोड़ने वाली भारतीय वैज्ञानिक परंपराओं का व्यापक परिचय।",
    summary_en: "A broad introduction to Indian scientific traditions spanning mathematics, astronomy, medicine, metallurgy, linguistics and natural philosophy.",
    externalUrl: "ancient-indian-science-tradition.html"
  }
